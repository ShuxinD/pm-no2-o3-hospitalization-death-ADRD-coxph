...
print(HR)
write.table(HR, paste0(dir_results, "cox_mortality_pm25_race4_HR.csv"))
tb <- as.data.frame(tb)
...
rownames(HR) <- c("Black", "White", "Others", "Hispanic")
print(HR)
write.table(HR, paste0(dir_results, "cox_mortality_no2_race4_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
rownames(HR) <- c("Black", "White", "Others", "Hispanic")
print(HR)
write.table(HR, paste0(dir_results, "cox_mortality_ozone_summer_race4_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
rownames(HR) <- c("Black", "White", "Others", "Hispanic")
print(HR)
write.table(HR, paste0(dir_results, "cox_mortality_ox_race4_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
