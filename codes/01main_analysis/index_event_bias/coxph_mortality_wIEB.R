...
IPWs <- read_fst(paste0(dir_data, "ADRDcohort_mortality_ipw_ieb.fst"), as.data.table = T)
names(dt)
names(IPWs)
...
dir_out <- "/nfs/home/S/shd968/shared_space/ci3_shd968/dementia/airPollution_ADRD/results/main_analyses/index_event_bias/coxph_mortality/"
...
#' summary(truncate_ipw(ipw_ieb_all3_raw, 0.975, 0.025))
#' ipw_ieb_all3 <- truncate_ipw(ipw_ieb_all3_raw, 0.975, 0.025)
