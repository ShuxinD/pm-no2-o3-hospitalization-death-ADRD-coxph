...
IQRunit <- IQRs$pm25
### sex 0/1 -----
cox_pm25_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
write.csv(HR, paste0(dir_results, "cox_ReAd_pm25_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_pm25_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_pm25_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
                         pm25 + I(pm25*dual) +
                         mean_bmi + smoke_rate + hispanic + pct_blk + 
                         medhouseholdincome + medianhousevalue +  
                         poverty + education + popdensity + pct_owner_occ +
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_pm25_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_pm25_dual_coef.csv"))

### population density T/F----
cox_pm25_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_pm25_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_pm25_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_pm25_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_pm25_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_pm25_entryage_coef.csv"))
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_pm25_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
IQRunit <- IQRs$no2
### sex 0/1 -----
cox_no2_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_no2_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_no2_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_no2_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
                        no2 + I(no2*dual) +
                        mean_bmi + smoke_rate + hispanic + pct_blk + 
                        medhouseholdincome + medianhousevalue +  
                        poverty + education + popdensity + pct_owner_occ +
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_no2_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_no2_dual_coef.csv"))

### population density T/F----
cox_no2_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_no2_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_no2_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_no2_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_no2_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_no2_entryage_coef.csv"))
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_no2_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
### sex 0/1 -----
cox_ozone_summer_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ozone_summer_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ozone_summer_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_ozone_summer_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ozone_summer_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ozone_summer_dual_coef.csv"))

### population density T/F----
cox_ozone_summer_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ozone_summer_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ozone_summer_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_ozone_summer_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ozone_summer_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ozone_summer_entryage_coef.csv"))
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ozone_summer_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
IQRunit <- IQRs$ox
### sex 0/1 -----
cox_ox_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
                      ox + I(ox*sex_female) +
                      mean_bmi + smoke_rate + hispanic + pct_blk + 
                      medhouseholdincome + medianhousevalue +  
                      poverty + education + popdensity + pct_owner_occ +
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ox_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ox_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_ox_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
                       ox + I(ox*dual) +
                       mean_bmi + smoke_rate + hispanic + pct_blk + 
                       medhouseholdincome + medianhousevalue +  
                       poverty + education + popdensity + pct_owner_occ +
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ox_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ox_dual_coef.csv"))

### population density T/F----
cox_ox_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ox_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ox_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_ox_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ox_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_ox_entryage_coef.csv"))
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_ox_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
...
IQRunit <- IQRs$pm25
### sex 0/1 -----
cox_all3_pm25_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_pm25_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_pm25_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_all3_pm25_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_pm25_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_all3_pm25_dual_coef.csv"))

### population density T/F----
cox_all3_pm25_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_pm25_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_pm25_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_all3_pm25_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_pm25_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_pm25_entryage_coef.csv"))

### race chr 3 levels ----
cox_all3_pm25_race <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_pm25_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_pm25_race_coef.csv"))

## 6. effect modification for NO2 in multi-pollutant model -----------------
IQRunit <- IQRs$no2
### sex 0/1 -----
cox_all3_no2_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_no2_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_no2_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_all3_no2_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_no2_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_all3_no2_dual_coef.csv"))

### population density T/F----
cox_all3_no2_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_no2_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_no2_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_all3_no2_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_no2_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_no2_entryage_coef.csv"))

### race chr 3 levels ----
cox_all3_no2_race <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_no2_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_no2_race_coef.csv"))

## 7. effect modification for ozone_summer in multi-pollutant model -----------------
IQRunit <- IQRs$ozone_summer
### sex 0/1 -----
cox_all3_ozone_summer_sex <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_ozone_summer_sex_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_ozone_summer_sex_coef.csv"))

### dual eligibility 0/1 ----
cox_all3_ozone_summer_dual <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_ozone_summer_dual_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_all3_ozone_summer_dual_coef.csv"))

### population density T/F----
cox_all3_ozone_summer_popdensity <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_ozone_summer_popdensity_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_ozone_summer_popdensity_coef.csv"))

### entry age over85 T/F-----
cox_all3_ozone_summer_entryage <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_ozone_summer_entryage_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_ozone_summer_entryage_coef.csv"))

### race chr 3 levels ----
cox_all3_ozone_summer_race <- coxph(Surv(time = followupyr, time2 = followupyr_plusone, event = ReAd) ~ 
...
HR <- as.data.frame(HR)
colnames(HR) <- c("coef", "IQR", "HR", "HR_lci", "HR_uci")
write.csv(HR, paste0(dir_results, "cox_ReAd_all3_ozone_summer_race_HR.csv"))
tb <- as.data.frame(tb)
setDT(tb, keep.rownames = TRUE)
fwrite(tb, paste0(dir_results, "cox_ReAd_all3_ozone_summer_race_coef.csv"))
