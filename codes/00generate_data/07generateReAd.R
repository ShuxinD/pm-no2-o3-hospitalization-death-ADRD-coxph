...
dim(ADRDcohort_hosp) # [1] 42421734       4

any(duplicated(ADRDcohort_hosp))  # TRUE
sum(duplicated(ADRDcohort_hosp)) # 4626 number of duplicates
ADRDcohort_hosp <- unique(ADRDcohort_hosp) # remove all the duplicates
dim(ADRDcohort_hosp) # [1] 42417108       31 # dimention after removing duplicates
gc()
...
dim(ADRDcohort_hosp_time) # [1] 23986044        2
gc()
