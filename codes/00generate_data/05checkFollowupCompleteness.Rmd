...
dir_ADRDpeople <-  "/nfs/home/S/shd968/shared_space/ci3_shd968/dementia/data/"
dir_enrolledInfo <-  "/nfs/home/S/shd968/shared_space/ci3_shd968/dementia/data/"

ADRDpeople <- fread(paste0(dir_ADRDpeople, "ADRDpeople.csv"), colClasses = c("zip"="character"))
...
We constructed a temporary dataset named `temp` which is a subset of `ADRDpeople` after removing NA and removing rows whose `year==firstADRDyr`, and summarize each person as one row (the number of unique subjects) with `r dim(temp)[1]` subjects:
